...
<head>
	...
	<title>Catalogo - Carrito de Compras Online con PHP, JavaScript y MySQL :: José Ayala</title>
</head>
			...
			<div class="row align-items-center">
				<div class="col-lg-12 text-center">
					<div class="section_title">
						<img class="img-fluid" src="assets/images/mueble.gif" alt="muebles">
					</div>
				</div>
			</div>
					...
					<div class="col-6 col-md-3 mt-5 text-center Products">
						<div class="card" style="max-height: 400px !important; min-height: 400px !important;">
							...
							<div class=" card-body text-center">
								...
								<!--
								(ESTO SIRVE PARA CATEGORIZAR POR ESTRELLAS LA CALIDAD DE LAS COSAS)?php
